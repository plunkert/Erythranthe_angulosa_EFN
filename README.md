...
## Induction_exp.csv
Data from an EFN induction experiment applying three treatments (clipping, Jasmonic acid application, 
...
Data collected on the morphology (stem thickness, leaf size, and stem number) of progeny from 
...
## Data in Phenotype_morphology.csv
